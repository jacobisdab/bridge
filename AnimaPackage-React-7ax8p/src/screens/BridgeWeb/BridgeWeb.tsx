...
export const BridgeWeb = (): JSX.Element => {
  return (
    <div className="bg-[#ececec] flex flex-row justify-center w-full">
      <div className="bg-[#ececec] w-[707px] h-[1881px] relative">
        <img className="absolute w-[707px] h-[59px] top-0 left-0" alt="Header" src="/img/header.png" />
        <div className="absolute w-[707px] h-[441px] top-[98px] left-0">
          <div className="absolute w-[289px] h-[98px] top-[31px] left-[20px]">
            <img
              ...
              src="/img/where-students-build-businesses-thrive-and-opportunities-unite.png"
            />
            <img className="w-[66px] top-[25px] left-[195px] absolute h-[3px]" alt="Line" src="/img/line-1.png" />
            <img className="w-[70px] top-[94px] left-[219px] absolute h-[3px]" alt="Line" src="/img/line-3.svg" />
            <img className="w-[75px] top-[60px] left-[141px] absolute h-[3px]" alt="Line" src="/img/line-2.svg" />
          ...
          <div className="absolute w-[707px] h-[441px] top-0 left-0">
            <img className="absolute w-[707px] h-[92px] top-[349px] left-0" alt="Vector" src="/img/vector-1.svg" />
            <div className="absolute w-[300px] h-[350px] top-0 left-[381px] bg-white rounded-[15px] overflow-hidden">
              <img
                ...
                alt="Img"
                src="/img/wechat26c15506a6a1ff6431b22e5a4b5c0fdf-1.png"
              />
            </div>
          </div>
        </div>
        ...
        <div className="absolute w-[120px] h-[120px] top-[861px] left-[56px] bg-white rounded-[10px]">
          <img
            ...
            alt="Img"
            src="/img/wechat270012ca5921463318f4dbed4f488aa9-1.png"
          />
        </div>
        <div className="absolute w-[120px] h-[120px] top-[861px] left-[375px] bg-white rounded-[10px]">
          <img
            ...
            alt="Img"
            src="/img/wechat93fb8bc1ebc46c9f9f74c2791be33189-1.png"
          />
        </div>
        <div className="absolute w-[120px] h-[120px] top-[820px] left-[216px] bg-white rounded-[10px]">
          <img
            ...
            alt="Img"
            src="/img/wechatc4b5e885a85c8c948014445b8e530f23-1.png"
          />
        </div>
        <div className="absolute w-[120px] h-[120px] top-[820px] left-[531px] bg-white rounded-[10px]">
          <img
            ...
            alt="Img"
            src="/img/wechat6463563f8eae616600ab7f34dbba9018-1.png"
          />
        </div>
        ...
        <div className="absolute w-[707px] h-[215px] top-[1666px] left-0 [background:linear-gradient(180deg,rgba(255,1.06,229.61,0.44)_0%,rgba(170,109,247,0.73)_100%)]">
          ...
          <img
            ...
            src="/img/for-any-inquiries-please-contact-us-at-bridgeup2023-gmail-com-b.png"
          />
        </div>
      </div>
    </div>
